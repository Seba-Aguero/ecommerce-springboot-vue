  ...
  <AuthCard>
    ...
    <form @submit.prevent="handleLogin" class="space-y-6">
      ...
      <button
        type="submit"
        :disabled="loading"
        class="mt-6 w-full bg-gradient-to-r from-primary-500 to-purple-500 hover:from-primary-600 hover:to-purple-600 text-white font-semibold py-3 px-4 rounded-lg shadow-sm transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center disabled:opacity-50"
      >
        <svg
          v-if="loading"
